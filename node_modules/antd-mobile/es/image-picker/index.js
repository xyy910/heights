            ...
            files.forEach(function (image, index) {
                ...
                imgItemList.push(React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('div', { className: prefixCls + '-item-remove', role: 'button', 'aria-label': 'Click and Remove this image', onClick: function onClick() {
                                _this2.removeImage(index);
                            } }),
                        React.createElement('div', { className: prefixCls + '-item-content', role: 'button', 'aria-label': 'Image can be clicked', onClick: function onClick() {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { ref: function ref(input) {
                            ...
                            }, type: 'file', accept: accept, onChange: function onChange() {
                                _this2.onFileChange();
                            }, multiple: multiple })
                    )
                )
